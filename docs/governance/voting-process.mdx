...
* **v1INCH:** This is an ERC-20 which represents 1INCH tokens that are currently locked in the vesting contract. These tokens are held by backers, advisors, and core contributors but are not yet fully-vested. With the implementation of [1IP-68](https://snapshot.org/#/1inch.eth/proposal/0xbd23ac94adbaf23d3f8e48ace73107939c97dab860ce09b51fec65cc3d78eacd), v1INCH no longer holds voting weight in 1inch DAO.
